...
module.exports = {
    ...
    exitMarketCompound: async (evmWeb3, options) => {

        const filterOptions = options;
        filterOptions.function = "exitMarketCompound()";
    ...
    exitMarketCompoundV3: async () => throwErrorMessage("notApplicable"),
