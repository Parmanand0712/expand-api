 ...
 * 
    standard schema of a getOrders response
    {
        orders: []
    }
 */
...
module.exports = {
    ...
    getOrdersDYDXV4: async (web3, options) => {
        /*
         * Function will fetch the orders from dydx v4
         */
        ...
        try {
            const response = await indexerClientGoerli.account.getSubaccountOrders(address, subAccountNumber);
