 ...
 * 
    standard schema of a getFills response
    {
        fills: []
    }
...
module.exports = {
    ...
    getFillsDYDXV4: async (web3, options) => {
        /*
        ...
        try {
            const response = await indexerClientGoerli.account.getSubaccountFills(address, subAccountNumber);
