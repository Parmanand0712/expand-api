 ...
 * 
    standard schema of a getTransfers response
    {
        transfers: []
    }
 */
...
const { getSubAccountsDYDXV4 } = require('./getSubAccounts');
    ...
    module.exports = {
        ...
        getTransfersDYDXV4: async (web3, options) => {
            /*
             * Function will fetch all the transfers from dydx v4
             */
            ...
            try {
                const response = await indexerClientGoerli.account.getSubaccountTransfers(address, subAccountNumber);
